...
Module "Origin(MDC1998)"
	Channels 8
	Sequence 0,1,2,2,3,3,4,4,5,6,7,8,9,9,10,10,11,12,13,13,13,13,14
	Instrument 1
	...
	Instrument 31
		Name "======VAZ+HammerHead!="
	Macro 32 Root C-2
		Note "C-2-1---" Repeat Begin
		Note "C-2-19F4" Repeat 15
		Note "C-2-2---" Repeat Begin
		Note "C-2-29F4" Repeat 15
	Macro 33 Root C-2
		Note "C-2-3---" Repeat Begin
		Note "C-2-39F4" Repeat 15
		Note "C-2-4---" Repeat Begin
		Note "C-2-49F4" Repeat 15
	Macro 34 Root C-2
		Note "C-2-5---" Repeat Begin
		Note "C-2-59F4" Repeat 15
		Note "C-2-6---" Repeat Begin
		Note "C-2-69F4" Repeat 15
	Macro 35 Root C-2
		Note "C-211---" Repeat Begin
		Note "C-2119F8" Repeat 7
		Note "C-212---" Repeat Begin
		Note "C-2129F8" Repeat 7
		Note "C-213---" Repeat Begin
		Note "C-2139F8" Repeat 7
		Note "C-214---" Repeat Begin
		Note "C-2149F8" Repeat 7
		Note "C-215---" Repeat Begin
		Note "C-2159F8" Repeat 7
	...
	Macro 37 Root B-4
		...
		Repeat 8
	Macro 38 Root C-2
		Note "C-210C00" Repeat Begin
		Note "-----A8F" Repeat 31
	Macro 39 Root C-2
		Note "C-210C40" Repeat Begin
		Note "-----AF8" Repeat 31
	Pattern 0
		Row "00 A#432--- A#433--- -----C00 -----C00 -----C00 -----C00 -----C00 -----C00"
