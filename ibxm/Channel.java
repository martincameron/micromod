...
public class Channel {
	...
	private static final int[] periodTable = {
		...
		27392, 27195, 27000, 26805, 26612, 26421, 26231, 26042,
		25855, 25669, 25484, 25301, 25119, 24938, 24759, 24581,
		24404, 24228, 24054, 23881, 23709, 23538, 23369, 23201,
		23034, 22868, 22704, 22541, 22378, 22217, 22058, 21899,
		21741, 21585, 21430, 21275, 21122, 20970, 20820, 20670,
		20521, 20373, 20227, 20081, 19937, 19793, 19651, 19510,
		19369, 19230, 19092, 18954, 18818, 18683, 18548, 18415,
		18282, 18151, 18020, 17890, 17762, 17634, 17507, 17381,
		17256, 17132, 17009, 16886, 16765, 16644, 16525, 16406,
		16288, 16170, 16054, 15939, 15824, 15710, 15597, 15485,
		15373, 15263, 15153, 15044, 14936, 14828, 14722, 14616,
		14511, 14406, 14303, 14200, 14098, 13996, 13895, 13795,
		13696, 13598, 13500, 13403, 13306, 13211, 13116, 13021,
		12928, 12835, 12742, 12651, 12560, 12469, 12380, 12291,
		12202, 12114, 12027, 11941, 11855, 11769, 11685, 11601
	};
	...
	private void trigger() {
		...
		if( noteKey > 0 ) {
			if( noteKey > 96 ) {
				...
				if( key > 120 ) key = 120;
				if( module.linearPeriods ) {
					portaPeriod = 7744 - ( key << 6 ) - ( fineTune >> 1 );
				} else {
	...
	public static int keyToPeriod( int key ) {
		int period = ( periodTable[ ( key % 12 ) << 3 ] << 1 ) >> ( key / 12 );
